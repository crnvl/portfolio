...
export default function Navbar() {
  ...
  const toggleTheme = (event) => {
    ...
    if (event.target.id !== "themeToggle") return;
  ...
  return (
    <>
      ...
      <dialog id="shortcuts-modal" className="modal">
        <div className="modal-box space-y-2">
          <h3 className="font-bold text-lg">Global shortcuts</h3>
          <aside>
            <kbd className="kbd">0</kbd> Home
          </aside>
          <aside>
          ...
          <aside>
            <kbd className="kbd">`</kbd> Toggle Theme
          </aside>
          <aside>
            <kbd className="kbd">Ctrl</kbd> + <kbd className="kbd">Q</kbd> Open
            shortcut view
          </aside>
